<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EditTask.aspx.vb" Inherits="Tasks_EditTask2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style type="text/css">
       ...
       #col1 {
        width: 45%; /* Ширина первой колонки */
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder2">
    <br /><br /><table width="700px">
        ...
        <tr>
         ...
         <tr>
            ...
            <td id="col2" width="60px">
                <asp:TextBox ID="txtDateEnd" runat="server" MaxLength="10"
                    onkeydown="javascript:return dFilter (event.keyCode, this, '##.##.####');" Width="159px"></asp:TextBox>
                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtDateEnd"
        ...
        <tr>
            <td id="col1" width="250px">
                <asp:Label ID="Label5" runat="server" Text="Затраченное время,часы" ></asp:Label>
            </td>
            <td id="col2" width="60px">
                <asp:TextBox ID="txtTimeElapsed" runat="server" Width="167px" ></asp:TextBox>  
            </td>
        </tr>

        <tr>
            <td id="col1" width="250px">
                <asp:Label ID="Label6" runat="server" Text="Статус задачи" ></asp:Label>
            </td>
            <td id="col2" width="60px">
                <asp:TextBox ID="txtStatusTask" runat="server" Width="167px" ></asp:TextBox>  
            </td>
        </tr>

         <tr>
            <td id="col1" width="250px">
                <asp:Label ID="Label7" runat="server" Text="Автор задачи" ></asp:Label>
            </td>
            <td id="col2" width="60px">
    ...
    <tr>
        ...
        <asp:Panel ID="Panel1" runat="server">
            ...
            <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="~/Database.accdb" DeleteCommand="DELETE FROM Documents WHERE (idDocument = @idDocument)" SelectCommand="SELECT idDocument, idTask, Url FROM Documents WHERE (idTask = @idTask)" UpdateCommand="UPDATE Documents SET idTask = ?, Url = ?, NameDoc = ?">
                <SelectParameters>
    ...
    <asp:AccessDataSource ID="AccessDataSource3" runat="server" DataFile="~/Database.accdb" SelectCommand="SELECT idUser, Surname +' '+Name as FIO FROM Users">
        <SelectParameters>
            <asp:SessionParameter Name="?" SessionField="IDU" />
        </SelectParameters>
    </asp:AccessDataSource>
    <asp:AccessDataSource ID="AccessDataSource2" runat="server" DataFile="~/Database.accdb" 
        SelectCommand="SELECT  Users.Surname + ' ' + Users.Name AS FI,Comment.Comment,Users.idUser,
        idTask,Comment.IdComment FROM (Comment INNER JOIN Users ON Comment.IdUser = Users.idUser)
